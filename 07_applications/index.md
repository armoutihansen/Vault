...
This layer does **not** contain code (→ `08_reference_implementations`), model theory (→ `03_modeling`), or engineering patterns (→ `05_ml_engineering`, `06_ai_engineering`).
...
08_reference_implementations/ → HOW it is implemented in code
