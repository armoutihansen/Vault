...
- [[js_async]] — event loop, call stack, task queue, microtask queue, Promises, `async`/`await`
- [[js_modules]] — CommonJS, ES Modules, `"type": "module"`, bundlers (Webpack, Vite, Rollup)
- [[js_runtimes]] — Node.js, npm, Deno, Bun comparison, polyfills, transpilers
