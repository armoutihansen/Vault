...
For an $m \times n$ matrix $\mathrm{A}$, there are two additional fundamental vector spaces beyond the [[01_foundations/math/linear_algebra/vector_spaces/column_space|column space]] and [[01_foundations/math/linear_algebra/vector_spaces/null_space|null space]]:
...
A [[01_foundations/math/linear_algebra/vector_spaces/span_basis_dimension|basis]] for the row space can be read directly from $\mathrm{rref(A)}$: the non-zero rows (written as column vectors) with pivot entries form a basis.
