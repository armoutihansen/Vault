...
Given the [[01_foundations/math/linear_algebra/linear_systems/lu_decomposition|LU Decomposition]] $\rm A = LU$, solving $\rm Ax = b$ reduces to two triangular solves, which is efficient for multiple right-hand sides.
...
Standard computational method for solving [[01_foundations/math/linear_algebra/linear_systems/systems_of_linear_equations|Systems of Linear Equations]] with a fixed coefficient matrix and multiple right-hand sides (e.g., finite-element solvers, iterative refinement).
