...
From [[01_foundations/math/linear_algebra/linear_systems/elementary_matrices|Elementary Matrices]], Gaussian elimination gives
$$
...
Solving $\rm Ax = b$ for many vectors $\rm b$ — see [[01_foundations/math/linear_algebra/linear_systems/solving_lu|Solving (LU)x=b]]. Also used internally for determinant computation and matrix inversion.
...
- [[01_foundations/math/linear_algebra/linear_systems/elementary_matrices|Elementary Matrices]]
- [[01_foundations/math/linear_algebra/linear_systems/gaussian_elimination|Gaussian Elimination]]
- [[01_foundations/math/linear_algebra/linear_systems/solving_lu|Solving (LU)x=b]]
