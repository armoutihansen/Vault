...
A **Taylor series** is a [[01_foundations/math/calculus/series/power_series|power series]] representation of a function $f(x)$ about a point $x = a$, constructed so that all derivatives of the series match those of $f$ at $a$.
...
Taylor series provide polynomial approximations to smooth functions. The linear approximation $f(x+\epsilon)\approx f(x)+f'(x)\epsilon$ underlies [[01_foundations/math/calculus/series/lhospitals_rule|L'Hôpital's Rule]].
...
- [[01_foundations/math/calculus/series/power_series|Power Series]]
- [[01_foundations/math/calculus/series/geometric_series|Geometric Series]]
- [[01_foundations/math/calculus/series/lhospitals_rule|L'Hôpital's Rule]]
- [[01_foundations/math/calculus/series/harmonic_and_p_series|Harmonic and p-Series]] — alternating harmonic series sums to $\ln 2$
- [[01_foundations/math/calculus/complex_numbers|Complex Numbers]] — Euler's formula $e^{i\theta}=\cos\theta+i\sin\theta$ follows from the exponential Taylor series
