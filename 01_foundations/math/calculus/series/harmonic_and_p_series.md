...
The p-series is a standard benchmark for comparison tests. The harmonic series and its alternating form appear in the [[01_foundations/math/calculus/series/taylor_series|Taylor Series]] of $\ln(1+x)$ evaluated at $x = 1$.
...
- [[01_foundations/math/calculus/series/taylor_series|Taylor Series]] — the value $\ln 2$ follows from the Taylor series of $\ln(1+x)$ at $x=1$
