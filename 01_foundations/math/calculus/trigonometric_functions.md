...
- [[01_foundations/math/calculus/complex_numbers|Complex Numbers]] — Euler's formula connects $e^{i\theta}$ to $\cos\theta$ and $\sin\theta$
- [[01_foundations/math/calculus/growth_decay_oscillation|Growth, Decay and Oscillation]] — sinusoidal solutions to $\ddot{x}+\omega^{2}x=0$
