...
$$
- If either $m$ or $n$ is **odd**, apply the Pythagorean identity $\sin^2\theta+\cos^2\theta=1$ to reduce to a single trigonometric function, then use [[01_foundations/math/calculus/integration/integration_by_substitution|substitution]].
...
- [[01_foundations/math/calculus/integration/integration_by_substitution|Integration by Substitution]]
- [[01_foundations/math/calculus/integration/integrals|Integrals]]
